      ...
      <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden">
        ...
        <header className="w-full px-6 py-6 md:px-12 flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-6">
            <a className="text-sm font-medium text-slate-600 hover:text-primary dark:text-slate-400 dark:hover:text-white transition-colors" href="#">Help Center</a>
            <a className="text-sm font-medium text-slate-600 hover:text-primary dark:text-slate-400 dark:hover:text-white transition-colors" href="#">Contact Support</a>
          </div>
        </header>
              ...
              <div className="relative z-10 w-full h-full rounded-2xl overflow-hidden shadow-2xl">
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 p-8 text-white w-full bg-gradient-to-t from-black/60 to-transparent">
                    ...
                    <p className="text-lg font-medium">"The best way to organize my seminar notes. Simple and effective."</p>
                  </div>
                </div>
              </div>
            </div>
